...
## Features
- Automatically adds before:YYYY-MM-DD to all searches
- Exact Search: Option to wrap queries in quotes for exact matching
- Sort Options: Choose default sort by relevance, upload date, or view count

## License
Free to use and modify for personal use. Feel free to fork and submit pull requests for improvements!